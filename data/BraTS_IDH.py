...
class BraTS(Dataset):
    ...
    def __getitem__(self, item):
        ...
        #path='/mnt/K/WHZ/datasets/BraTS2020 T+V/BraTS2020_TrainingData/MICCAI_BraTS2020_TrainingData/BraTS20_Training_192/BraTS20_Training_192_'
        data = pkload(path + 'data_f32b0.pkl')
        data_2=pkload(path + 'data_f32b0_2.pkl')
        # data_2=pkload(path + 'data_f32b0_2_1.pkl')
        #data_2_2 = pkload(path + 'data_f32b0_2_2.pkl')
        # print(len(data))
        # print(len(data_2))
        if self.mode == 'train':
            #print("++++++++++++++++++",len(data))
            ...
            if len(data)==3:
                ...
                #     sample_2_2 = transform(sample_2_2)
                    ...
                    return sample['image'],idh_target,atrx_target,p19q_target,sample_2['image'],path #sample['weight']
            ...
            if len(data) == 2:
                ...
                #     sample_2_2 = {'image': image_2_2}
                #     sample_2_2 = transform(sample_2_2)
                    return sample['image'],idh_target, atrx_target, p19q_target,sample_2['image']
